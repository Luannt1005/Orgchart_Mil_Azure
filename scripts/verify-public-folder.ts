...
async function verify() {
    try {
        ...
        const foundPrivate1 = charts1.find((c: any) => c.orgchart_id === privateChart.orgchart_id);
        const foundPublic1 = charts1.find((c: any) => c.orgchart_id === publicChart.orgchart_id);
        ...
        const foundPrivate2 = charts2.find((c: any) => c.orgchart_id === privateChart.orgchart_id);
        const foundPublic2 = charts2.find((c: any) => c.orgchart_id === publicChart.orgchart_id);
        ...
        const foundPrivate3 = charts3.find((c: any) => c.orgchart_id === privateChart.orgchart_id);
